...
const Calculator = () => {
  ...
  const getButtonValues = (type = 'left') => {
    ...
    const values = {
      top: [
        { id: 'clear', value: 'AC', isOval: true, backgroundColor: '#fff', textColor: colors.red },
      ...
      left: [
        ...
        { id: 'eight', value: '8' },
        { id: 'nine', value: '9' },
        { id: 'remove', value: 'C', isOval: true, backgroundColor: '#34386A' },
        { id: 'zero', value: '0' },
        { id: 'decimal', value: '.' },
      ],
      right: [
  ...
  return (
    <CalculatorWrapper>
      <MenuButtonLink href="https://github.com/zendy199x/calculator-react" title="Source Code" target="_blank">
